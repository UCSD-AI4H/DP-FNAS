...
class DARTSCell(nn.Module):
    ...
    def forward(self, inputs, hidden, weights_in):
        ...
        hiddens = []
        for t in range(T):
            hidden = self.cell(inputs[t], hidden, x_mask, h_mask, weights_in)
...
class RNNModel(nn.Module):
    ...
    def forward(self, input, hidden, return_h=False):
        ...
        for l, rnn in enumerate(self.rnns):
            ...
            raw_output, new_h = rnn(raw_output, hidden[l], self.weights)
